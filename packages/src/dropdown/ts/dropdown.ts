...
export class Dropdown {
  ...
  constructor(dropdownElement: HTMLElement) {
    ...
    this.button = this.dropdown.querySelector('[data-dui-toggle="dropdown"]') as HTMLElement;
    this.menu = this.dropdown.querySelector('[data-dui-role="menu"]') as HTMLElement;
