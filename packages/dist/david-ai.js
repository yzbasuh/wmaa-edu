  ...
  function toggleCollapse(event) {
      ...
      if (collapseID && collapseID.startsWith("#")) {
          ...
          if (collapseElement) {
              ...
              const icon = button.querySelector("[data-dui-icon]");
              if (icon) {
  ...
  */
  ...
  function initPopovers() {
      document.querySelectorAll("[data-dui-toggle='popover']").forEach((trigger) => {
          ...
          const contentElement = ((_a = trigger.nextElementSibling) === null || _a === void 0 ? void 0 : _a.matches("[data-dui-popover-content]"))
  ...
  function initTooltips() {
      document.querySelectorAll("[data-dui-toggle='tooltip']").forEach((trigger) => {
          ...
          if ((_a = trigger.nextElementSibling) === null || _a === void 0 ? void 0 : _a.matches("[data-dui-tooltip-content]")) {
  ...
  function initTabs() {
      document.querySelectorAll(".tab-group").forEach((tabGroup) => {
          ...
          function activateTab(link) {
              ...
              const targetContentId = link.getAttribute("data-dui-tab-target");
  ...
  function toggleAccordion(event) {
      ...
      const parentElement = button.closest("[data-dui-accordion-container]");
      const mode = parentElement === null || parentElement === void 0 ? void 0 : parentElement.dataset.duiAccordionMode;
      if (targetID === null || targetID === void 0 ? void 0 : targetID.startsWith("#")) {
          const targetElement = document.querySelector(targetID);
          const isExpanded = button.getAttribute("aria-expanded") === "true";
          if (mode === "exclusive" && parentElement) {
              parentElement.querySelectorAll("[data-dui-accordion-toggle]").forEach(otherButton => {
  ...
  class Accordion {
      ...
      setAccordionState(button, content, isExpanded) {
          ...
          const icon = button.querySelector('[data-dui-accordion-icon]');
          if (icon) {
              icon.classList.toggle('rotate-180', isExpanded);
          }
      }
  ...
  function updateStepperState(container) {
      const steps = container.querySelectorAll("[data-dui-step]");
      const stepContents = container.querySelectorAll("[data-dui-step-content]");
      const prevButtons = container.querySelectorAll("[data-dui-stepper-prev]");
      const nextButtons = container.querySelectorAll("[data-dui-stepper-next]");
  ...
  function initStepper() {
      document.querySelectorAll("[data-dui-stepper-container]").forEach((container) => {
